...
console.log(chalk.yellow.bold('𝐓𝐡𝐚𝐧𝐤𝐬 𝐮𝐝𝐚𝐡 𝐩𝐚𝐤𝐞 𝐒𝐜𝐫𝐢𝐩𝐭 𝐏𝐚𝐧𝐧𝐎𝐟𝐟𝐜 V3\n🎭⃟𖤇𝐏𝐚𝐧𝐧𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐋🐦‍🔥\n𝐓𝐡𝐚𝐧𝐤𝐬 𝐓𝐨\n-𝐏𝐚𝐧𝐧𝐎𝐟𝐟𝐜 -𝐃𝐞𝐯\n-𝐎𝐫𝐭𝐮\n-𝐀𝐋𝐋𝐀𝐇 𝐒𝐖𝐓\n-𝐃𝐚𝐧 𝐊𝐚𝐰𝐚𝐧-𝐊𝐚𝐰𝐚𝐧'))
...
PannOfficiaL.sendMessage(`6283896168449@s.whatsapp.net`, { text: `\` 💧⃟𒆜𝐏𝐚𝐧𝐧𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥𝟒𝟒𝟒⃟╳🐦‍🔥 `/` 𝐒𝐮𝐜𝐜𝐞𝐬 𝐂𝐨𝐧𝐧𝐞𝐜𝐭 𝐁𝐨𝐭 𝐏𝐚𝐧𝐧𝐎𝐟𝐟𝐜 𝐕𝟑`})
if (autoJoin) {
...
require("./V3 - PannOffc.js")(PannOfficiaL, m, store)
} catch (err) {
console.log(err)
}
})
